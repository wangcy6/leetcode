 ...
 * print(nums[i]);
 * }
 * 看似很容易，但是写代码出现挣扎，无从下手，
 * 没有算法描述，就是不行。
 * 删除记录后数组长度变动。
 *  遍历一次，然后统计单词个数，如果大于2 总数--，然后标记？ 后面同意移动。
 *  https://leetcode-cn.com/problems/remove-duplicates-from-sorted-array-ii/solution/cxiang-xi-jie-shi-shuang-zhi-zhen-jie-fa-by-edward/
 
 *   nums = [1,1,1,2,2,3],  1, 1, 2, 2, 3 
 * 
 *   1,1,1,2,2,3
 *   https://leetcode-cn.com/problems/remove-duplicates-from-sorted-array-ii/solution/shuang-zhi-zhen-hua-dong-chuang-kou-shi-jian-on-ko/
 *  
 */
